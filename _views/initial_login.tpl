                        ...
                        <div id="tabs-1">
                            ...
                            <ul class="form terms">
                            	<li>
                                    ...
                                    <li class="checkboxes bottom-line"><input type="checkbox" id="agb" /><label for="agb">Ich habe die Nutzungsbedingungen gelesen und stimme Ihnen zu</label></li>
                                </li>
                                <li>
                                	<input class="button red center" value="Konto aktivieren" />
                                </li>
                            </ul>
