...
{{ else }}
 ...
 {'1':1,'3':3,'66':66,'65':65,'54':54};
  {{* section Politik *}}
  {{ elseif $gimme->publication->identifier == 2 && $gimme->section->number == 10 }}
 ...
 {'2':2,'4':4,'5':5,'68':68,'23':23,'55':55,'28':28};
  {{* section Kultur *}}
  {{ elseif $gimme->publication->identifier == 2 && $gimme->section->number == 30 }}
 {'30':30,'70':70,'33':33,'58':58,'39':39};
  {{* section Gesellschaft *}}
  {{ elseif $gimme->publication->identifier == 2 && $gimme->section->number == 40 }}
 {'41':41,'69':69,'44':44,'57':57,'49':49};
  {{* section Dialog *}}
  {{ elseif $gimme->publication->identifier == 2 && $gimme->section->number == 90 }}
 {'77':77,'72':72,'64':64,'59':59,'84':84};
  {{* Dossiers page *}}
  {{ elseif $gimme->template->name == "dossiers.tpl" }}
 {'78':78,'79':79,'87':87};
  {{* blogs page *}}
  {{ elseif $gimme->template->name == "blogs.tpl" }}
 {'75':75,'71':71,'62':62,'60':60,'85':85};
  {{* ausgehen page *}}
  {{ elseif $gimme->template->name == "ausgehen.tpl" || ($gimme->section->number gt 70 && $gimme->section->number lte 80) }}
