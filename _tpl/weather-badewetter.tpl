                ...
                <!-- badewetter elements -->
                <div id='mn-badewetter-important-baths'>
                    <h3 class='top-line'>Beliebte Badeorte</h3>
                    <table id='mn-wintersport-important-slopes-table' cellpadding='0' cellspacing='0' class='top-line second-row-phone-hide'>
                        ...
                        <tbody>
                                ...
                                {{ list_weather_stats location_list="all_baths" location_name="Lauerzersee" length="1" }}
                                    {{ include file="_tpl/weather-all-baths.tpl" }}
                                {{ /list_weather_stats }}
                                {{ list_weather_stats location_list="all_baths" location_name="Ägerisee, Oberägeri" length="1" }}
                                    {{ include file="_tpl/weather-all-baths.tpl" }}
                                {{ /list_weather_stats }}
                                {{ list_weather_stats location_list="all_baths" region_name="Luzern" location_name="Sempachersee, Sempach" length="1" }}
                                    {{ include file="_tpl/weather-all-baths.tpl" }}
                                {{ /list_weather_stats }}
                                {{ list_weather_stats location_list="all_baths" region_name="Nidwalden" location_name="Vierwaldstättersee, Hergiswil" length="1" }}
                                    {{ include file="_tpl/weather-all-baths.tpl" }}
                                {{ /list_weather_stats }}
                                {{ list_weather_stats location_list="all_baths" region_name="Luzern" location_name="Vierwaldstättersee, Luzern" length="1" }}
                                    {{ include file="_tpl/weather-all-baths.tpl" }}
                                {{ /list_weather_stats }}
                ...
                <div id='mn-badewetter-all-regions' class='tabs ui-tabs ui-widget ui-widget-content ui-corner-all'>
                    <h3>Alle Badeorte</h3>
                    ...
                    <div id="table-1" aria-labelledby="ui-id-1" class="ui-tabs-panel ui-widget-content ui-corner-bottom" role="tabpanel" style="display: block;" aria-expanded="true" aria-hidden="false">
                        ...
                        <table cellpadding="0" cellspacing="0" class="top-line second-row-phone-hide paginated-table">
                            ...
                            <tbody>
                                {{ list_weather_stats location_list="all_baths" }}
                                    {{ include file="_tpl/weather-all-baths.tpl" }}
                                {{ /list_weather_stats }} 
                            </tbody>
                        </table>
                        ...
                        <ul class="paging center">
                            <li><a id='mn-all-baths-first' class="button white prev" href="#">‹‹</a></li>
                            <li><a id='mn-all-baths-prev' class="button white prev" href="#">‹</a></li>
                            <li id='mn-all-baths-caption' class="caption">1 von 2</li>
                            <li><a id='mn-all-baths-next' class="button white next" href="#">›</a></li>
                            <li><a id='mn-all-baths-last' class="button white next" href="#">››</a></li>
                        </ul>
                    ...
                    <div id="table-2" aria-labelledby="ui-id-1" class="ui-tabs-panel ui-widget-content ui-corner-bottom" role="tabpanel" style="display: none;" aria-expanded="false" aria-hidden="true">
                        <table cellpadding="0" cellspacing="0" class="top-line second-row-phone-hide">
                            ...
                            <tbody>
                                {{ list_weather_stats location_list="all_baths" region_name="Luzern" length="7" }}
                                    {{ include file="_tpl/weather-all-baths.tpl" }}
                                {{ /list_weather_stats }} 
                            </tbody>
                        </table>
                    ...
                    <div id="table-3" aria-labelledby="ui-id-1" class="ui-tabs-panel ui-widget-content ui-corner-bottom" role="tabpanel" style="display: none;" aria-expanded="false" aria-hidden="true">
                        <table cellpadding="0" cellspacing="0" class="top-line second-row-phone-hide">
                            ...
                            <tbody>
                                {{ list_weather_stats location_list="all_baths" region_name="Uri" length="7" }}
                                    {{ include file="_tpl/weather-all-baths.tpl" }}
                                {{ /list_weather_stats }} 
                            </tbody>
                        </table>
                    ...
                    <div id="table-4" aria-labelledby="ui-id-1" class="ui-tabs-panel ui-widget-content ui-corner-bottom" role="tabpanel" style="display: none;" aria-expanded="false" aria-hidden="true">
                        <table cellpadding="0" cellspacing="0" class="top-line second-row-phone-hide">
                            ...
                            <tbody>
                                {{ list_weather_stats location_list="all_baths" region_name="Schwyz" length="7" }}
                                    {{ include file="_tpl/weather-all-baths.tpl" }}
                                {{ /list_weather_stats }} 
                            </tbody>
                        </table>
                    ...
                    <div id="table-5" aria-labelledby="ui-id-1" class="ui-tabs-panel ui-widget-content ui-corner-bottom" role="tabpanel" style="display: none;" aria-expanded="false" aria-hidden="true">
                        <table cellpadding="0" cellspacing="0" class="top-line second-row-phone-hide">
                            ...
                            <tbody>
                                {{ list_weather_stats location_list="all_baths" region_name="Obwalden" length="7" }}
                                    {{ include file="_tpl/weather-all-baths.tpl" }}
                                {{ /list_weather_stats }} 
                            </tbody>
                        </table>
                    ...
                    <div id="table-6" aria-labelledby="ui-id-1" class="ui-tabs-panel ui-widget-content ui-corner-bottom" role="tabpanel" style="display: none;" aria-expanded="false" aria-hidden="true">
                        <table cellpadding="0" cellspacing="0" class="top-line second-row-phone-hide">
                            ...
                            <tbody>
                                {{ list_weather_stats location_list="all_baths" region_name="Nidwalden" length="7" }}
                                    {{ include file="_tpl/weather-all-baths.tpl" }}
                                {{ /list_weather_stats }} 
                            </tbody>
                        </table>
                    ...
                    <div id="table-7" aria-labelledby="ui-id-1" class="ui-tabs-panel ui-widget-content ui-corner-bottom" role="tabpanel" style="display: none;" aria-expanded="false" aria-hidden="true">
                        <table cellpadding="0" cellspacing="0" class="top-line second-row-phone-hide">
                            ...
                            <tbody>
                                {{ list_weather_stats location_list="all_baths" region_name="Zug" length="7" }}
                                    {{ include file="_tpl/weather-all-baths.tpl" }}
                                {{ /list_weather_stats }} 
                            </tbody>
                        </table>
