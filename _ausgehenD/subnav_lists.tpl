...
window.load_area = function(area) {
    ...
    {{ include file="_ausgehen/top_event_movie_teaser.tpl" }}

                <div class="content top-line no-bottom-line clearfix">
                <div class="two-columns blog-list featured-blogs equal-heights clearfix">

                <article id="agenda_teaser_event" style="display:none;">
                </article>

                <article id="agenda_teaser_movie" style="display:none;">
                </article>
...
{{ /local }}
            ...
            <div class="events-aside clearfix">

                <div class="box desktop-hide">
                    <h4>Was</h4>
                    <select id="sel_was" class="dropdownized" onChange="window.load_events(this); return true;">
                        <option value="all">Alles</option>
                        <option value="kino">Kino</option>
                        <option value="theater">Theater</option>
                        <option value="musik">Konzerte</option>
                        <option value="party">Partys</option>
                        <option value="ausstellung">Ausstellungen</option>
                        <option value="andere">Diverse</option>
{{ if 0 }}
...
{{ /if }}
                ...
                <div class="box calendar-placeholder">
                    <h4>Wann</h4>
...
{{ assign var="day_span_notice" "Bitte Zeitspanne auswählen"}}
                ...
                <div class="box">
                    <h4>Wo</h4>
                    <select class="dropdownized" onChange="window.load_area(this); return true;">
                ...
                <p><a href="mailto:agenda@tageswoche.ch">Ihre Veranstaltung fehlt?</a></p>
