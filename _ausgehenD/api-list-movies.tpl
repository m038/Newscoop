...
//alert($("#wann").val());
//alert($("#wann").datepicker("getDate"));
console.log($("#wann").datepicker("getDate"));
console.log($("#wann"));

    //setTimeout('$("#wann").datepicker("setDate", new Date("{{ $cinema_date }}"));', 10);
    setTimeout("update_datepicker_button(); update_datepicker_visible();", 100);
});
...
{{ include file="_ausgehen/api-teaser-place.tpl" }}
    ...
    <div class="wide-wrapper no-top-margin internal-wrapper">
        ...
        <div class="content-wrapper events-content">
            ...
            {{ include file="_ausgehen/subnav-lists-side.tpl" }}
