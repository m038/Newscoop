                    ...
                    <div class="box filter-side">
                        ...
                        <ul class="categories">
                            {{ foreach from=$cuisin_list key=kueche_key item=kueche_info }}
                                <li class="{{* active *}} li_kueche" id="li_{{ $kueche_info.label }}"><input type="checkbox" id="filter_{{ $kueche_info.label }}" /><label for="filter_{{ $kueche_info.label }}">{{*<a href="#" onClick="load_kueche('{{ $kueche_info.label }}'); return false;">*}}{{ $kueche_info.display }}{{*</a>*}}</label></li>
                            {{ /foreach }}
                        </ul>
